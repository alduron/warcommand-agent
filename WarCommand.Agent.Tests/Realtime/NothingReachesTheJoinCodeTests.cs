...
public sealed class NothingReachesTheJoinCodeTests
{
    ...
    public void Every_entry_point_on_the_observer_is_accounted_for()
    {
        ...
        [
            ...
            "OnRequestSubmitted", "OnRequestClaimed", "OnRequestStarted", "OnRequestRoundsAway",
            "OnRequestAdjusted", "OnRequestReleased", "OnRequestEscalated", "OnRequestCompleted",
            "OnRequestCancelled", "OnRequestExpired", "OnRequestSuperseded", "OnClaimsReconcile",
